...
- Batch D — §12 *floating-point basic IEEE family*: sign / bit ops
  ...
  top of §12 to `fN`; remaining members (ldexp/ilogb/logb, fract/recip)
  are planned as follow-up sub-batches.  See
