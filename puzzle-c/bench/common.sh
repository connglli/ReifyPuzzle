#!/usr/bin/env bash
# -----------------------------------------------------------------------
# common.sh — Shared utility logic for C puzzle agent runners.
# -----------------------------------------------------------------------
...
#   puzzle.c            The C puzzle to solve
#   tools/              Symlinks to puzzle toolchain (rypuzchk.py, etc.)
#   workspace/          Writable scratch space
#   system.md           Instructions (pre-processed with runtime paths)
#
# Outputs (agent must produce):
#   solution.c          The solved puzzle (if successful)
